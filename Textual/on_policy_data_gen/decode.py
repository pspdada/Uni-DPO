...
parser.add_argument(
    "--data_dir", type=str, default="HuggingFaceH4/ultrafeedback_binarized", help="Directory containing the data"
)
parser.add_argument("--model", type=str, default="google/gemma-2-9b-it", help="Path to the LLM model")
parser.add_argument("--temperature", type=float, default=0.8, help="Temperature for sampling")
parser.add_argument("--top_p", type=float, default=0.95, help="Top-p probability for sampling")
parser.add_argument("--max_tokens", type=int, default=4096, help="Maximum number of tokens to generate")
parser.add_argument("--seed", type=int, default=42, help="Random seed")
parser.add_argument("--output_dir", type=str, default="datasets/gemma2_ultrafeedback", help="output_dir")
