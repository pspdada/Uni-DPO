...
from Math.evaluation.scripts.eval_utils.utils import load_jsonl, lower_keys


def load_data(data_name: str, split: str, data_dir: str) -> list[dict]:
    data_file = f"{data_dir}/{data_name}/{split}.jsonl"
    if os.path.exists(data_file):
        print(f"Loading {data_name} from {data_file}")
        try:
