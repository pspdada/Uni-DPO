...
class PairwiseDatasetProcessor(DatasetProcessor):
    ...
    def preprocess_dataset(self, examples: dict[str, list[Any]]) -> dict[str, list[Any]]:
        ...
        for i in range(len(examples["_prompt"])):
            ...
            model_inputs["score_chosen"].append(examples["_score_chosen"][i])
            model_inputs["score_rejected"].append(examples["_score_rejected"][i])
    ...
    def print_data_example(self, example: dict[str, list[int]]) -> None:
        ...
        print(f"score_chosen: {example['score_chosen']}")
        print(f"score_rejected: {example['score_rejected']}")
